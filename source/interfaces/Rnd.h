...
inline double rnd(void) { return (double)RandomInteger/Random_Max; } 


//-------------------Auxiliary random number routines---------------------

inline double rnd (double max) 			{return max*rnd();}
inline double rnd (double min, double max) 	{return min+(max-min)*rnd();}
